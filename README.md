This is repo for the LinuxBox application. If you are looking for the installer scripts and distro bootstrap scripts, please visit [here]([https://github.com/EXALAB/AnLinux-Resources](https://github.com/NextAppsLab/LinuxBoxResources))
...
The installer script download custom bootstrapped Linux distro , then decompress the image and then mount it using [PRoot](https://github.com/proot-me/PRoot).
...
2. Device requirements:
   ...
   Android Version : Android 24+ (Nougat)
